...
- **Format**: PNG
- **Resolution**: 1024 × 1792 pixels (portrait orientation for sanatan-verse-sdk)
...
Use the [sanatan-verse-sdk](https://pypi.org/project/sanatan-verse-sdk/) for standardized image generation:
...
**Prompt file format** (required by sanatan-verse-sdk):
```markdown
### Verse 1: Title
...
### Using sanatan-verse-sdk (Sundar Kaand)
...
3. **Generate images** using sanatan-verse-sdk:
   ```bash
...
### sanatan-verse-sdk Generation Issues
...
- **sanatan-verse-sdk**: [PyPI](https://pypi.org/project/sanatan-verse-sdk/)
